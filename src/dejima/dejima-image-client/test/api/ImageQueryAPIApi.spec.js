...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.ImageQueryAPIApi();
  });
  ...
  describe('ImageQueryAPIApi', function() {
    describe('bulkGetMetadataRentRentListGet', function() {
      it('should call bulkGetMetadataRentRentListGet successfully', function(done) {
        //uncomment below and update the code to test bulkGetMetadataRentRentListGet
        //instance.bulkGetMetadataRentRentListGet(function(error) {
    ...
    describe('bulkGetMetadataSaleSaleListGet', function() {
      it('should call bulkGetMetadataSaleSaleListGet successfully', function(done) {
        //uncomment below and update the code to test bulkGetMetadataSaleSaleListGet
        //instance.bulkGetMetadataSaleSaleListGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getImageRentRentImgPropertyKeyFilenameGet', function() {
      it('should call getImageRentRentImgPropertyKeyFilenameGet successfully', function(done) {
        //uncomment below and update the code to test getImageRentRentImgPropertyKeyFilenameGet
        //instance.getImageRentRentImgPropertyKeyFilenameGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getImageSaleSaleImgPropertyKeyFilenameGet', function() {
      it('should call getImageSaleSaleImgPropertyKeyFilenameGet successfully', function(done) {
        //uncomment below and update the code to test getImageSaleSaleImgPropertyKeyFilenameGet
        //instance.getImageSaleSaleImgPropertyKeyFilenameGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getMetadataRentRentPropertyKeyGet', function() {
      it('should call getMetadataRentRentPropertyKeyGet successfully', function(done) {
        //uncomment below and update the code to test getMetadataRentRentPropertyKeyGet
        //instance.getMetadataRentRentPropertyKeyGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getMetadataSaleSalePropertyKeyGet', function() {
      it('should call getMetadataSaleSalePropertyKeyGet successfully', function(done) {
        //uncomment below and update the code to test getMetadataSaleSalePropertyKeyGet
        //instance.getMetadataSaleSalePropertyKeyGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
