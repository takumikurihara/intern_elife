...
class MetadataResponse {
     ...
     * @param hashType {String} 画像データのハッシュを計算するハッシュ関数名  通常はCRC32
     * @param hashValue {String} 画像データのハッシュ値
     * @param height {Number} 画像高さのピクセル数
     * @param kind {String} 画像種別  物件内でユニーク。rentとsaleで共通
     * @param kindCode {String} 画像種別コード  物件内でユニーク。rentとsaleで共通
     * @param modified {String} 画像の最終更新日時  RFC1123形式
     * @param propertyKey {String} いい生活番号  スマートOneコンバートでは物件識別コード(PROPERTY_KEY_TEXT)と呼ばれている
     * @param url {String} 画像URL  このURLを利用して画像データを取得する。
     * @param width {Number} 画像横幅のピクセル数
     */
    constructor(hashType, hashValue, height, kind, kindCode, modified, propertyKey, url, width) { 
        
        MetadataResponse.initialize(this, hashType, hashValue, height, kind, kindCode, modified, propertyKey, url, width);
    }
     ...
     */
    static initialize(obj, hashType, hashValue, height, kind, kindCode, modified, propertyKey, url, width) { 
        obj['hash_type'] = hashType;
        obj['hash_value'] = hashValue;
        obj['height'] = height;
        obj['kind'] = kind;
        obj['kind_code'] = kindCode;
        obj['modified'] = modified;
        obj['property_key'] = propertyKey;
        obj['url'] = url;
        obj['width'] = width;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('hash_value')) {
                obj['hash_value'] = ApiClient.convertToType(data['hash_value'], 'String');
            }
            ...
            if (data.hasOwnProperty('kind_code')) {
                obj['kind_code'] = ApiClient.convertToType(data['kind_code'], 'String');
            }
...
/**
 * 画像カテゴリー  賃貸物件と売買物件で異なる。
 * @member {String} category
 */
MetadataResponse.prototype['category'] = undefined;

/**
 * 画像コメント
 * @member {String} comment
 */
MetadataResponse.prototype['comment'] = undefined;

/**
 * 画像説明
 * @member {String} description
 */
MetadataResponse.prototype['description'] = undefined;

/**
 * 画像データのハッシュを計算するハッシュ関数名  通常はCRC32
 * @member {String} hash_type
 */
MetadataResponse.prototype['hash_type'] = undefined;

/**
 * 画像データのハッシュ値
 * @member {String} hash_value
 */
MetadataResponse.prototype['hash_value'] = undefined;

/**
 * 画像高さのピクセル数
 * @member {Number} height
 */
MetadataResponse.prototype['height'] = undefined;

/**
 * 画像種別  物件内でユニーク。rentとsaleで共通
 * @member {String} kind
 */
MetadataResponse.prototype['kind'] = undefined;

/**
 * 画像種別コード  物件内でユニーク。rentとsaleで共通
 * @member {String} kind_code
 */
MetadataResponse.prototype['kind_code'] = undefined;

/**
 * 画像の最終更新日時  RFC1123形式
 * @member {String} modified
 */
MetadataResponse.prototype['modified'] = undefined;

/**
 * いい生活番号  スマートOneコンバートでは物件識別コード(PROPERTY_KEY_TEXT)と呼ばれている
 * @member {String} property_key
 */
MetadataResponse.prototype['property_key'] = undefined;

/**
 * 画像URL  このURLを利用して画像データを取得する。
 * @member {String} url
 */
MetadataResponse.prototype['url'] = undefined;

/**
 * 画像横幅のピクセル数
 * @member {Number} width
 */
MetadataResponse.prototype['width'] = undefined;
