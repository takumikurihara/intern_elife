...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EsApi.TagQueryAPIApi();
  });
  ...
  describe('TagQueryAPIApi', function() {
    describe('listTag', function() {
      it('should call listTag successfully', function(done) {
        //uncomment below and update the code to test listTag
        //instance.listTag(function(error) {
