...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EsApi.BuildingQueryAPIApi();
  });
  ...
  describe('BuildingQueryAPIApi', function() {
    ...
    describe('searchBuilding', function() {
      it('should call searchBuilding successfully', function(done) {
        //uncomment below and update the code to test searchBuilding
        //instance.searchBuilding(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
