...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EsApi.RentPropertyQueryAPIApi();
  });
  ...
  describe('RentPropertyQueryAPIApi', function() {
    describe('aggregateRentPropertyByArea', function() {
      it('should call aggregateRentPropertyByArea successfully', function(done) {
        //uncomment below and update the code to test aggregateRentPropertyByArea
        //instance.aggregateRentPropertyByArea(function(error) {
    ...
    describe('aggregateRentPropertyByLine', function() {
      it('should call aggregateRentPropertyByLine successfully', function(done) {
        //uncomment below and update the code to test aggregateRentPropertyByLine
        //instance.aggregateRentPropertyByLine(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('choiceRentProperty', function() {
      it('should call choiceRentProperty successfully', function(done) {
        //uncomment below and update the code to test choiceRentProperty
        //instance.choiceRentProperty(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getRentProperty', function() {
      it('should call getRentProperty successfully', function(done) {
        //uncomment below and update the code to test getRentProperty
        //instance.getRentProperty(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('searchRentPropertyByBuilding', function() {
      it('should call searchRentPropertyByBuilding successfully', function(done) {
        //uncomment below and update the code to test searchRentPropertyByBuilding
        //instance.searchRentPropertyByBuilding(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('searchRentPropertyByDwellingUnit', function() {
      it('should call searchRentPropertyByDwellingUnit successfully', function(done) {
        //uncomment below and update the code to test searchRentPropertyByDwellingUnit
        //instance.searchRentPropertyByDwellingUnit(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
