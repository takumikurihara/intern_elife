...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EsApi.AgentQueryAPIApi();
  });
  ...
  describe('AgentQueryAPIApi', function() {
    describe('getAgentByCustomerKey', function() {
      it('should call getAgentByCustomerKey successfully', function(done) {
        //uncomment below and update the code to test getAgentByCustomerKey
        //instance.getAgentByCustomerKey(function(error) {
    ...
    describe('getStaff', function() {
      it('should call getStaff successfully', function(done) {
        //uncomment below and update the code to test getStaff
        //instance.getStaff(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('listAgent', function() {
      it('should call listAgent successfully', function(done) {
        //uncomment below and update the code to test listAgent
        //instance.listAgent(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
