...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EsApi.LineAggregateResult();
  });
  ...
  describe('LineAggregateResult', function() {
    it('should create an instance of LineAggregateResult', function() {
      // uncomment below and update the code to test LineAggregateResult
      //var instane = new EsApi.LineAggregateResult();
      //expect(instance).to.be.a(EsApi.LineAggregateResult);
    });
