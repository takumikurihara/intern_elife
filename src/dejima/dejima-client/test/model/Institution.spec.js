...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EsApi.Institution();
  });
  ...
  describe('Institution', function() {
    it('should create an instance of Institution', function() {
      ...
      //var instane = new EsApi.Institution();
      //expect(instance).to.be.a(EsApi.Institution);
    });

    it('should have the property institutionCategory (base name: "institution_category")', function() {
      // uncomment below and update the code to test the property institutionCategory
      //var instane = new EsApi.Institution();
      //expect(instance).to.be();
    });

    it('should have the property institutionCategoryCode (base name: "institution_category_code")', function() {
      // uncomment below and update the code to test the property institutionCategoryCode
      //var instane = new EsApi.Institution();
      //expect(instance).to.be();
    });
    ...
    it('should have the property relativePosition (base name: "relative_position")', function() {
      // uncomment below and update the code to test the property relativePosition
      //var instane = new EsApi.Institution();
      //expect(instance).to.be();
    });

    it('should have the property relativePositionCode (base name: "relative_position_code")', function() {
      // uncomment below and update the code to test the property relativePositionCode
      //var instane = new EsApi.Institution();
      //expect(instance).to.be();
    });

    it('should have the property institutionDistance (base name: "institution_distance")', function() {
      // uncomment below and update the code to test the property institutionDistance
      //var instane = new EsApi.Institution();
      //expect(instance).to.be();
    });
