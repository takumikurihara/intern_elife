...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EsApi.BuildingList();
  });
  ...
  describe('BuildingList', function() {
    it('should create an instance of BuildingList', function() {
      // uncomment below and update the code to test BuildingList
      //var instane = new EsApi.BuildingList();
      //expect(instance).to.be.a(EsApi.BuildingList);
    });
