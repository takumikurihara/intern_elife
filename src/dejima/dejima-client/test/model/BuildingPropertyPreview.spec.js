...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EsApi.BuildingPropertyPreview();
  });
  ...
  describe('BuildingPropertyPreview', function() {
    it('should create an instance of BuildingPropertyPreview', function() {
      // uncomment below and update the code to test BuildingPropertyPreview
      //var instane = new EsApi.BuildingPropertyPreview();
      //expect(instance).to.be.a(EsApi.BuildingPropertyPreview);
    });
    ...
    it('should have the property parallel2ParkingFlag (base name: "parallel_2_parking_flag")', function() {
      // uncomment below and update the code to test the property parallel2ParkingFlag
      //var instane = new EsApi.BuildingPropertyPreview();
      //expect(instance).to.be();
    });

    it('should have the property parallel3ParkingFlag (base name: "parallel_3_parking_flag")', function() {
      // uncomment below and update the code to test the property parallel3ParkingFlag
      //var instane = new EsApi.BuildingPropertyPreview();
      //expect(instance).to.be();
    });

    it('should have the property hasLargeGarage (base name: "has_large_garage")', function() {
      // uncomment below and update the code to test the property hasLargeGarage
      //var instane = new EsApi.BuildingPropertyPreview();
      //expect(instance).to.be();
    });

    it('should have the property hasVisitorsParking (base name: "has_visitors_parking")', function() {
      // uncomment below and update the code to test the property hasVisitorsParking
      //var instane = new EsApi.BuildingPropertyPreview();
      //expect(instance).to.be();
    });

    it('should have the property hasGarage (base name: "has_garage")', function() {
      // uncomment below and update the code to test the property hasGarage
      //var instane = new EsApi.BuildingPropertyPreview();
      //expect(instance).to.be();
    });

    it('should have the property hasDeliveryBox (base name: "has_delivery_box")', function() {
      // uncomment below and update the code to test the property hasDeliveryBox
      //var instane = new EsApi.BuildingPropertyPreview();
      //expect(instance).to.be();
    });

    it('should have the property propertyTotalCounts (base name: "property_total_counts")', function() {
      // uncomment below and update the code to test the property propertyTotalCounts
      //var instane = new EsApi.BuildingPropertyPreview();
      //expect(instance).to.be();
    });
