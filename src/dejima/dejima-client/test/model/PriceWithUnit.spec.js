...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EsApi.PriceWithUnit();
  });
  ...
  describe('PriceWithUnit', function() {
    it('should create an instance of PriceWithUnit', function() {
      // uncomment below and update the code to test PriceWithUnit
      //var instane = new EsApi.PriceWithUnit();
      //expect(instance).to.be.a(EsApi.PriceWithUnit);
    });
