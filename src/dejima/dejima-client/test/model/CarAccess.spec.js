...
(function(root, factory) {
  ...
  describe('CarAccess', function() {
    it('should create an instance of CarAccess', function() {
      // uncomment below and update the code to test CarAccess
      //var instane = new EsApi.CarAccess();
      //expect(instance).to.be.a(EsApi.CarAccess);
    });
