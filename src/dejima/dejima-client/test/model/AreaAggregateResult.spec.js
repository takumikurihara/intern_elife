...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EsApi.AreaAggregateResult();
  });
  ...
  describe('AreaAggregateResult', function() {
    it('should create an instance of AreaAggregateResult', function() {
      // uncomment below and update the code to test AreaAggregateResult
      //var instane = new EsApi.AreaAggregateResult();
      //expect(instance).to.be.a(EsApi.AreaAggregateResult);
    });
