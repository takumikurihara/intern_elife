...
(function(root, factory) {
  ...
  describe('FacingRoad', function() {
    it('should create an instance of FacingRoad', function() {
      // uncomment below and update the code to test FacingRoad
      //var instane = new EsApi.FacingRoad();
      //expect(instance).to.be.a(EsApi.FacingRoad);
    });

    it('should have the property roadKind (base name: "road_kind")', function() {
      // uncomment below and update the code to test the property roadKind
      //var instane = new EsApi.FacingRoad();
      //expect(instance).to.be();
    });

    it('should have the property roadKindCode (base name: "road_kind_code")', function() {
      // uncomment below and update the code to test the property roadKindCode
      //var instane = new EsApi.FacingRoad();
      //expect(instance).to.be();
    });

    it('should have the property roadDirection (base name: "road_direction")', function() {
      // uncomment below and update the code to test the property roadDirection
      //var instane = new EsApi.FacingRoad();
      //expect(instance).to.be();
    });

    it('should have the property roadDirectionCode (base name: "road_direction_code")', function() {
      // uncomment below and update the code to test the property roadDirectionCode
      //var instane = new EsApi.FacingRoad();
      //expect(instance).to.be();
    });

    it('should have the property roadWidth (base name: "road_width")', function() {
      // uncomment below and update the code to test the property roadWidth
      //var instane = new EsApi.FacingRoad();
      //expect(instance).to.be();
    });

    it('should have the property roadFacingLength (base name: "road_facing_length")', function() {
      // uncomment below and update the code to test the property roadFacingLength
      //var instane = new EsApi.FacingRoad();
      //expect(instance).to.be();
    });

    it('should have the property isPaved (base name: "is_paved")', function() {
      // uncomment below and update the code to test the property isPaved
      //var instane = new EsApi.FacingRoad();
      //expect(instance).to.be();
    });

    it('should have the property roadPositionFlag (base name: "road_position_flag")', function() {
      // uncomment below and update the code to test the property roadPositionFlag
      //var instane = new EsApi.FacingRoad();
      //expect(instance).to.be();
    });
