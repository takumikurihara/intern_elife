...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EsApi.LineAggregateElem();
  });
  ...
  describe('LineAggregateElem', function() {
    it('should create an instance of LineAggregateElem', function() {
      // uncomment below and update the code to test LineAggregateElem
      //var instane = new EsApi.LineAggregateElem();
      //expect(instance).to.be.a(EsApi.LineAggregateElem);
    });
    ...
    it('should have the property parentCode (base name: "parent_code")', function() {
