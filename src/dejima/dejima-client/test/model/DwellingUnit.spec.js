...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EsApi.DwellingUnit();
  });
  ...
  describe('DwellingUnit', function() {
    it('should create an instance of DwellingUnit', function() {
      // uncomment below and update the code to test DwellingUnit
      //var instane = new EsApi.DwellingUnit();
      //expect(instance).to.be.a(EsApi.DwellingUnit);
    });
    ...
    it('should have the property dwellingUnitFeature (base name: "dwelling_unit_feature")', function() {
      // uncomment below and update the code to test the property dwellingUnitFeature
      //var instane = new EsApi.DwellingUnit();
      //expect(instance).to.be();
    });

    it('should have the property dwellingUnitOuterFacility (base name: "dwelling_unit_outer_facility")', function() {
      // uncomment below and update the code to test the property dwellingUnitOuterFacility
      //var instane = new EsApi.DwellingUnit();
      //expect(instance).to.be();
    });
