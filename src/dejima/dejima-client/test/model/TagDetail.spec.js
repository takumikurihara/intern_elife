...
(function(root, factory) {
  ...
  describe('TagDetail', function() {
    it('should create an instance of TagDetail', function() {
      // uncomment below and update the code to test TagDetail
      //var instane = new EsApi.TagDetail();
      //expect(instance).to.be.a(EsApi.TagDetail);
    });

    it('should have the property tagGuid (base name: "tag_guid")', function() {
      // uncomment below and update the code to test the property tagGuid
      //var instane = new EsApi.TagDetail();
    ...
    it('should have the property tagGroupName (base name: "tag_group_name")', function() {
      // uncomment below and update the code to test the property tagGroupName
      //var instane = new EsApi.TagDetail();
      //expect(instance).to.be();
    });
