...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EsApi.Transportation();
  });
  ...
  describe('Transportation', function() {
    it('should create an instance of Transportation', function() {
      ...
      //var instane = new EsApi.Transportation();
      //expect(instance).to.be.a(EsApi.Transportation);
    });

    it('should have the property transportationKind (base name: "transportation_kind")', function() {
      // uncomment below and update the code to test the property transportationKind
      //var instane = new EsApi.Transportation();
      //expect(instance).to.be();
    });

    it('should have the property transportationKindCode (base name: "transportation_kind_code")', function() {
      // uncomment below and update the code to test the property transportationKindCode
      //var instane = new EsApi.Transportation();
      //expect(instance).to.be();
    });

    it('should have the property wayTo (base name: "way_to")', function() {
      // uncomment below and update the code to test the property wayTo
      //var instane = new EsApi.Transportation();
      //expect(instance).to.be();
    });

    it('should have the property wayToCode (base name: "way_to_code")', function() {
      // uncomment below and update the code to test the property wayToCode
      //var instane = new EsApi.Transportation();
      //expect(instance).to.be();
    });
    ...
    it('should have the property stationAccess (base name: "station_access")', function() {
      // uncomment below and update the code to test the property stationAccess
      //var instane = new EsApi.Transportation();
      //expect(instance).to.be();
    });

    it('should have the property busStopAccess (base name: "bus_stop_access")', function() {
      // uncomment below and update the code to test the property busStopAccess
      //var instane = new EsApi.Transportation();
      //expect(instance).to.be();
    });

    it('should have the property carAccess (base name: "car_access")', function() {
      // uncomment below and update the code to test the property carAccess
      //var instane = new EsApi.Transportation();
      //expect(instance).to.be();
    });
