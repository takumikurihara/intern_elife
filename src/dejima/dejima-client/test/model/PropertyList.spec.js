...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EsApi.PropertyList();
  });
  ...
  describe('PropertyList', function() {
    it('should create an instance of PropertyList', function() {
      // uncomment below and update the code to test PropertyList
      //var instane = new EsApi.PropertyList();
      //expect(instance).to.be.a(EsApi.PropertyList);
    });
