...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EsApi.ValueWithUnit();
  });
  ...
  describe('ValueWithUnit', function() {
    it('should create an instance of ValueWithUnit', function() {
      // uncomment below and update the code to test ValueWithUnit
      //var instane = new EsApi.ValueWithUnit();
      //expect(instance).to.be.a(EsApi.ValueWithUnit);
    });
