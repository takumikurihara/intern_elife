...
(function(root, factory) {
  ...
  describe('Insurance', function() {
    it('should create an instance of Insurance', function() {
      ...
      //var instane = new EsApi.Insurance();
      //expect(instance).to.be.a(EsApi.Insurance);
    });

    it('should have the property insuranceMonth (base name: "insurance_month")', function() {
      // uncomment below and update the code to test the property insuranceMonth
      //var instane = new EsApi.Insurance();
      //expect(instance).to.be();
    });

    it('should have the property insuranceName (base name: "insurance_name")', function() {
      // uncomment below and update the code to test the property insuranceName
      //var instane = new EsApi.Insurance();
      //expect(instance).to.be();
    });

    it('should have the property insuranceComment (base name: "insurance_comment")', function() {
      // uncomment below and update the code to test the property insuranceComment
      //var instane = new EsApi.Insurance();
      //expect(instance).to.be();
    });

    it('should have the property insurancePrice (base name: "insurance_price")', function() {
      // uncomment below and update the code to test the property insurancePrice
      //var instane = new EsApi.Insurance();
      //expect(instance).to.be();
    });
