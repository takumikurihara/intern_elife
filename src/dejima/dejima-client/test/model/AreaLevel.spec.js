...
(function(root, factory) {
  ...
  describe('AreaLevel', function() {
    it('should create an instance of AreaLevel', function() {
      // uncomment below and update the code to test AreaLevel
      //var instane = new EsApi.AreaLevel();
      //expect(instance).to.be.a(EsApi.AreaLevel);
    });
