...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EsApi.BuildingFeature();
  });
  ...
  describe('BuildingFeature', function() {
    it('should create an instance of BuildingFeature', function() {
      // uncomment below and update the code to test BuildingFeature
      //var instane = new EsApi.BuildingFeature();
      //expect(instance).to.be.a(EsApi.BuildingFeature);
    });
