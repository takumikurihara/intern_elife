...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EsApi.UseDistrict();
  });
  ...
  describe('UseDistrict', function() {
    it('should create an instance of UseDistrict', function() {
      // uncomment below and update the code to test UseDistrict
      //var instane = new EsApi.UseDistrict();
      //expect(instance).to.be.a(EsApi.UseDistrict);
    });
    ...
    it('should have the property useDistrictCode (base name: "use_district_code")', function() {
      // uncomment below and update the code to test the property useDistrictCode
      //var instane = new EsApi.UseDistrict();
      //expect(instance).to.be();
    });
