...
(function(root, factory) {
  ...
  describe('Room', function() {
    it('should create an instance of Room', function() {
      ...
      //var instane = new EsApi.Room();
      //expect(instance).to.be.a(EsApi.Room);
    });
    ...
    it('should have the property areaUnitCode (base name: "area_unit_code")', function() {
      // uncomment below and update the code to test the property areaUnitCode
      //var instane = new EsApi.Room();
      //expect(instance).to.be();
    });
