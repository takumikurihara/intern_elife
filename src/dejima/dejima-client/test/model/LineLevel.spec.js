...
(function(root, factory) {
  ...
  describe('LineLevel', function() {
    it('should create an instance of LineLevel', function() {
      // uncomment below and update the code to test LineLevel
      //var instane = new EsApi.LineLevel();
      //expect(instance).to.be.a(EsApi.LineLevel);
    });
