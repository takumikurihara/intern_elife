...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EsApi.BusStopAccess();
  });
  ...
  describe('BusStopAccess', function() {
    it('should create an instance of BusStopAccess', function() {
      // uncomment below and update the code to test BusStopAccess
      //var instane = new EsApi.BusStopAccess();
      //expect(instance).to.be.a(EsApi.BusStopAccess);
    });
    ...
    it('should have the property busLineName (base name: "bus_line_name")', function() {
      // uncomment below and update the code to test the property busLineName
      //var instane = new EsApi.BusStopAccess();
      //expect(instance).to.be();
    });

    it('should have the property busStopName (base name: "bus_stop_name")', function() {
      // uncomment below and update the code to test the property busStopName
      //var instane = new EsApi.BusStopAccess();
      //expect(instance).to.be();
    });

    it('should have the property ridingTime (base name: "riding_time")', function() {
      // uncomment below and update the code to test the property ridingTime
      //var instane = new EsApi.BusStopAccess();
      //expect(instance).to.be();
    });
