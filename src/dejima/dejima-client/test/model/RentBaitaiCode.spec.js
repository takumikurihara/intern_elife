...
(function(root, factory) {
  ...
  describe('RentBaitaiCode', function() {
    it('should create an instance of RentBaitaiCode', function() {
      // uncomment below and update the code to test RentBaitaiCode
      //var instane = new EsApi.RentBaitaiCode();
      //expect(instance).to.be.a(EsApi.RentBaitaiCode);
    });
