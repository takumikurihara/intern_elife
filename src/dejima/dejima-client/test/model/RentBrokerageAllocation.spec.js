...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EsApi.RentBrokerageAllocation();
  });
  ...
  describe('RentBrokerageAllocation', function() {
    it('should create an instance of RentBrokerageAllocation', function() {
      // uncomment below and update the code to test RentBrokerageAllocation
      //var instane = new EsApi.RentBrokerageAllocation();
      //expect(instance).to.be.a(EsApi.RentBrokerageAllocation);
    });

    it('should have the property brokerage (base name: "brokerage")', function() {
      // uncomment below and update the code to test the property brokerage
      //var instane = new EsApi.RentBrokerageAllocation();
    ...
    it('should have the property rentRewardStyle (base name: "rent_reward_style")', function() {
      // uncomment below and update the code to test the property rentRewardStyle
      //var instane = new EsApi.RentBrokerageAllocation();
      //expect(instance).to.be();
    });

    it('should have the property rentRewardStyleCode (base name: "rent_reward_style_code")', function() {
      // uncomment below and update the code to test the property rentRewardStyleCode
      //var instane = new EsApi.RentBrokerageAllocation();
      //expect(instance).to.be();
    });

    it('should have the property borrowerRate (base name: "borrower_rate")', function() {
      // uncomment below and update the code to test the property borrowerRate
      //var instane = new EsApi.RentBrokerageAllocation();
      //expect(instance).to.be();
    });

    it('should have the property ownerRate (base name: "owner_rate")', function() {
      // uncomment below and update the code to test the property ownerRate
      //var instane = new EsApi.RentBrokerageAllocation();
      //expect(instance).to.be();
    });

    it('should have the property borrowerSideAgentRate (base name: "borrower_side_agent_rate")', function() {
      // uncomment below and update the code to test the property borrowerSideAgentRate
      //var instane = new EsApi.RentBrokerageAllocation();
      //expect(instance).to.be();
    });

    it('should have the property ownerSideAgentRate (base name: "owner_side_agent_rate")', function() {
      // uncomment below and update the code to test the property ownerSideAgentRate
      //var instane = new EsApi.RentBrokerageAllocation();
      //expect(instance).to.be();
    });
