...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EsApi.AreaAggregateElem();
  });
  ...
  describe('AreaAggregateElem', function() {
    it('should create an instance of AreaAggregateElem', function() {
      // uncomment below and update the code to test AreaAggregateElem
      //var instane = new EsApi.AreaAggregateElem();
      //expect(instance).to.be.a(EsApi.AreaAggregateElem);
    });
