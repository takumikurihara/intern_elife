...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EsApi.DwellingUnitOuterFacility();
  });
  ...
  describe('DwellingUnitOuterFacility', function() {
    it('should create an instance of DwellingUnitOuterFacility', function() {
      // uncomment below and update the code to test DwellingUnitOuterFacility
      //var instane = new EsApi.DwellingUnitOuterFacility();
      //expect(instance).to.be.a(EsApi.DwellingUnitOuterFacility);
    });

    it('should have the property outerFacilityCategory (base name: "outer_facility_category")', function() {
      // uncomment below and update the code to test the property outerFacilityCategory
      //var instane = new EsApi.DwellingUnitOuterFacility();
      //expect(instance).to.be();
    });

    it('should have the property outerFacilityCategoryCode (base name: "outer_facility_category_code")', function() {
      // uncomment below and update the code to test the property outerFacilityCategoryCode
      //var instane = new EsApi.DwellingUnitOuterFacility();
      //expect(instance).to.be();
    });

    it('should have the property outerArea (base name: "outer_area")', function() {
      // uncomment below and update the code to test the property outerArea
      //var instane = new EsApi.DwellingUnitOuterFacility();
      //expect(instance).to.be();
    });
