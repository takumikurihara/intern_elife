...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EsApi.BuildingPropertyList();
  });
  ...
  describe('BuildingPropertyList', function() {
    it('should create an instance of BuildingPropertyList', function() {
      // uncomment below and update the code to test BuildingPropertyList
      //var instane = new EsApi.BuildingPropertyList();
      //expect(instance).to.be.a(EsApi.BuildingPropertyList);
    });
    ...
    it('should have the property itemsPerPage (base name: "items_per_page")', function() {
