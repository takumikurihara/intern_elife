...
(function(root, factory) {
  ...
  describe('RentPeriod', function() {
    it('should create an instance of RentPeriod', function() {
      // uncomment below and update the code to test RentPeriod
      //var instane = new EsApi.RentPeriod();
      //expect(instance).to.be.a(EsApi.RentPeriod);
    });
    ...
    it('should have the property contractTerm (base name: "contract_term")', function() {
      // uncomment below and update the code to test the property contractTerm
      //var instane = new EsApi.RentPeriod();
      //expect(instance).to.be();
    });

    it('should have the property contractEndDatejun (base name: "contract_end_datejun")', function() {
      // uncomment below and update the code to test the property contractEndDatejun
      //var instane = new EsApi.RentPeriod();
      //expect(instance).to.be();
    });
