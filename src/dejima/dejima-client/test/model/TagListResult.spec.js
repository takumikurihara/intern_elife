...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EsApi.TagListResult();
  });
  ...
  describe('TagListResult', function() {
    it('should create an instance of TagListResult', function() {
      // uncomment below and update the code to test TagListResult
      //var instane = new EsApi.TagListResult();
      //expect(instance).to.be.a(EsApi.TagListResult);
    });
