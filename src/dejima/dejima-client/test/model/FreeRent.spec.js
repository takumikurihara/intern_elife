...
(function(root, factory) {
  ...
  describe('FreeRent', function() {
    it('should create an instance of FreeRent', function() {
      // uncomment below and update the code to test FreeRent
      //var instane = new EsApi.FreeRent();
      //expect(instance).to.be.a(EsApi.FreeRent);
    });

    it('should have the property freeRentTerm (base name: "free_rent_term")', function() {
      // uncomment below and update the code to test the property freeRentTerm
      //var instane = new EsApi.FreeRent();
      //expect(instance).to.be();
    });

    it('should have the property freeRentPeriodDatejun (base name: "free_rent_period_datejun")', function() {
      // uncomment below and update the code to test the property freeRentPeriodDatejun
      //var instane = new EsApi.FreeRent();
      //expect(instance).to.be();
    });

    it('should have the property freeRentCondition (base name: "free_rent_condition")', function() {
      // uncomment below and update the code to test the property freeRentCondition
      //var instane = new EsApi.FreeRent();
      //expect(instance).to.be();
    });
