...
(function(root, factory) {
  ...
  describe('RentReform', function() {
    it('should create an instance of RentReform', function() {
      // uncomment below and update the code to test RentReform
      //var instane = new EsApi.RentReform();
      //expect(instance).to.be.a(EsApi.RentReform);
    });

    it('should have the property reformDetail (base name: "reform_detail")', function() {
      // uncomment below and update the code to test the property reformDetail
      //var instane = new EsApi.RentReform();
      //expect(instance).to.be();
    });

    it('should have the property reformDatejun (base name: "reform_datejun")', function() {
      // uncomment below and update the code to test the property reformDatejun
      //var instane = new EsApi.RentReform();
      //expect(instance).to.be();
    });
