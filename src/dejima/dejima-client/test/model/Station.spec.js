...
(function(root, factory) {
  ...
  describe('Station', function() {
    it('should create an instance of Station', function() {
      ...
      //var instane = new EsApi.Station();
      //expect(instance).to.be.a(EsApi.Station);
    });

    it('should have the property stationCode (base name: "station_code")', function() {
      // uncomment below and update the code to test the property stationCode
      //var instane = new EsApi.Station();
    ...
    it('should have the property lineCode (base name: "line_code")', function() {
      // uncomment below and update the code to test the property lineCode
      //var instane = new EsApi.Station();
      //expect(instance).to.be();
    });

    it('should have the property lineName (base name: "line_name")', function() {
