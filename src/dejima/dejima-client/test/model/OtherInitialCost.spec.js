...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EsApi.OtherInitialCost();
  });
  ...
  describe('OtherInitialCost', function() {
    it('should create an instance of OtherInitialCost', function() {
      // uncomment below and update the code to test OtherInitialCost
      //var instane = new EsApi.OtherInitialCost();
      //expect(instance).to.be.a(EsApi.OtherInitialCost);
    });
    ...
    it('should have the property otherInitialCostItem (base name: "other_initial_cost_item")', function() {
      // uncomment below and update the code to test the property otherInitialCostItem
      //var instane = new EsApi.OtherInitialCost();
      //expect(instance).to.be();
    });

    it('should have the property otherInitialCostComment (base name: "other_initial_cost_comment")', function() {
      // uncomment below and update the code to test the property otherInitialCostComment
      //var instane = new EsApi.OtherInitialCost();
      //expect(instance).to.be();
    });
