...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EsApi.OtherMonthlyCost();
  });
  ...
  describe('OtherMonthlyCost', function() {
    it('should create an instance of OtherMonthlyCost', function() {
      // uncomment below and update the code to test OtherMonthlyCost
      //var instane = new EsApi.OtherMonthlyCost();
      //expect(instance).to.be.a(EsApi.OtherMonthlyCost);
    });
    ...
    it('should have the property otherMonthlyCostItem (base name: "other_monthly_cost_item")', function() {
      // uncomment below and update the code to test the property otherMonthlyCostItem
      //var instane = new EsApi.OtherMonthlyCost();
      //expect(instance).to.be();
    });
