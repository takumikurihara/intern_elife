...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EsApi.DwellingUnitFeature();
  });
  ...
  describe('DwellingUnitFeature', function() {
    it('should create an instance of DwellingUnitFeature', function() {
      // uncomment below and update the code to test DwellingUnitFeature
      //var instane = new EsApi.DwellingUnitFeature();
      //expect(instance).to.be.a(EsApi.DwellingUnitFeature);
    });

    it('should have the property featureCategoryName (base name: "feature_category_name")', function() {
      // uncomment below and update the code to test the property featureCategoryName
      //var instane = new EsApi.DwellingUnitFeature();
