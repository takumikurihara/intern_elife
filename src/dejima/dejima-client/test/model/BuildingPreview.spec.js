...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EsApi.BuildingPreview();
  });
  ...
  describe('BuildingPreview', function() {
    it('should create an instance of BuildingPreview', function() {
      // uncomment below and update the code to test BuildingPreview
      //var instane = new EsApi.BuildingPreview();
      //expect(instance).to.be.a(EsApi.BuildingPreview);
    });
