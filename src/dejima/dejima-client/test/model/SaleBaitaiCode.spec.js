...
(function(root, factory) {
  ...
  describe('SaleBaitaiCode', function() {
    it('should create an instance of SaleBaitaiCode', function() {
      // uncomment below and update the code to test SaleBaitaiCode
      //var instane = new EsApi.SaleBaitaiCode();
      //expect(instance).to.be.a(EsApi.SaleBaitaiCode);
    });
