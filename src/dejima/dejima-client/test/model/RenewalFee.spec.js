...
(function(root, factory) {
  ...
  describe('RenewalFee', function() {
    it('should create an instance of RenewalFee', function() {
      // uncomment below and update the code to test RenewalFee
      //var instane = new EsApi.RenewalFee();
      //expect(instance).to.be.a(EsApi.RenewalFee);
    });
    ...
    it('should have the property isTaxIncluded (base name: "is_tax_included")', function() {
      // uncomment below and update the code to test the property isTaxIncluded
      //var instane = new EsApi.RenewalFee();
      //expect(instance).to.be();
    });

    it('should have the property isNonTaxable (base name: "is_non_taxable")', function() {
      // uncomment below and update the code to test the property isNonTaxable
      //var instane = new EsApi.RenewalFee();
      //expect(instance).to.be();
    });
    ...
    it('should have the property renewalFeeClass (base name: "renewal_fee_class")', function() {
      // uncomment below and update the code to test the property renewalFeeClass
      //var instane = new EsApi.RenewalFee();
      //expect(instance).to.be();
    });

    it('should have the property renewalFeeClassCode (base name: "renewal_fee_class_code")', function() {
      // uncomment below and update the code to test the property renewalFeeClassCode
      //var instane = new EsApi.RenewalFee();
      //expect(instance).to.be();
    });
