...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EsApi.RentPropertyPreviewBase();
  });
  ...
  describe('RentPropertyPreviewBase', function() {
    it('should create an instance of RentPropertyPreviewBase', function() {
      // uncomment below and update the code to test RentPropertyPreviewBase
      //var instane = new EsApi.RentPropertyPreviewBase();
      //expect(instance).to.be.a(EsApi.RentPropertyPreviewBase);
    });
