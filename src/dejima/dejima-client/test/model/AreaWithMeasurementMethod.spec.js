...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EsApi.AreaWithMeasurementMethod();
  });
  ...
  describe('AreaWithMeasurementMethod', function() {
    it('should create an instance of AreaWithMeasurementMethod', function() {
      // uncomment below and update the code to test AreaWithMeasurementMethod
      //var instane = new EsApi.AreaWithMeasurementMethod();
      //expect(instance).to.be.a(EsApi.AreaWithMeasurementMethod);
    });
    ...
    it('should have the property measurementMethod (base name: "measurement_method")', function() {
      // uncomment below and update the code to test the property measurementMethod
      //var instane = new EsApi.AreaWithMeasurementMethod();
      //expect(instance).to.be();
    });
