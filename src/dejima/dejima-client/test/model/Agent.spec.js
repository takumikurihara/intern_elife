...
(function(root, factory) {
  ...
  describe('Agent', function() {
    it('should create an instance of Agent', function() {
      ...
      //var instane = new EsApi.Agent();
      //expect(instance).to.be.a(EsApi.Agent);
    });
    ...
    it('should have the property agentTelNumber (base name: "agent_tel_number")', function() {
      // uncomment below and update the code to test the property agentTelNumber
      //var instane = new EsApi.Agent();
      //expect(instance).to.be();
    });

    it('should have the property agentFaxNumber (base name: "agent_fax_number")', function() {
      // uncomment below and update the code to test the property agentFaxNumber
      //var instane = new EsApi.Agent();
      //expect(instance).to.be();
    });

    it('should have the property agentEmail (base name: "agent_email")', function() {
      // uncomment below and update the code to test the property agentEmail
      //var instane = new EsApi.Agent();
      //expect(instance).to.be();
    });

    it('should have the property agentShopAddress (base name: "agent_shop_address")', function() {
      // uncomment below and update the code to test the property agentShopAddress
      //var instane = new EsApi.Agent();
      //expect(instance).to.be();
    });
    ...
    it('should have the property agentShopName (base name: "agent_shop_name")', function() {
      // uncomment below and update the code to test the property agentShopName
      //var instane = new EsApi.Agent();
      //expect(instance).to.be();
    });

    it('should have the property agentOrganization (base name: "agent_organization")', function() {
      // uncomment below and update the code to test the property agentOrganization
      //var instane = new EsApi.Agent();
      //expect(instance).to.be();
    });

    it('should have the property agentUrlCaption (base name: "agent_url_caption")', function() {
      // uncomment below and update the code to test the property agentUrlCaption
      //var instane = new EsApi.Agent();
      //expect(instance).to.be();
    });

    it('should have the property agentUrl (base name: "agent_url")', function() {
