...
(function(root, factory) {
  ...
  describe('Deposit', function() {
    it('should create an instance of Deposit', function() {
      ...
      //var instane = new EsApi.Deposit();
      //expect(instance).to.be.a(EsApi.Deposit);
    });
    ...
    it('should have the property additionalDeposit (base name: "additional_deposit")', function() {
      // uncomment below and update the code to test the property additionalDeposit
      //var instane = new EsApi.Deposit();
      //expect(instance).to.be();
    });

    it('should have the property additionalDepositReason (base name: "additional_deposit_reason")', function() {
      // uncomment below and update the code to test the property additionalDepositReason
      //var instane = new EsApi.Deposit();
      //expect(instance).to.be();
    });
