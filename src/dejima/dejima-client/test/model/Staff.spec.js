...
(function(root, factory) {
  ...
  describe('Staff', function() {
    it('should create an instance of Staff', function() {
      ...
      //var instane = new EsApi.Staff();
      //expect(instance).to.be.a(EsApi.Staff);
    });
    ...
    it('should have the property staffName (base name: "staff_name")', function() {
